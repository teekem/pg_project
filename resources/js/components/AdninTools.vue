...
<template>
 ...
 <!-- Tabs with card integration -->
    <b-card no-body>
      <b-tabs  small card>
        <b-tab title="Restore">  <!-- first tab start here -->
...
<!-- modal ends here -->
        ...
        <b-tab title="View Notifications">  <!-- second tab start here -->
            <div>
                <b-card no-body  >
                    <b-row no-gutters>
                    <b-col md="12">
...
<!-- modal ends here -->
    ...
    <div class="card card-primary">
  <div class="card-header">
	<h3 class="card-title">Select a log type to search</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
  <form @submit.prevent="newSession" role="form">
	<div class="card-body">
        <div>
    <b-form-select v-model="logSelected" :options="logOptions" @change="displayLogMethod"></b-form-select>
        </div>
    ...
    <div class="card card-primary" v-if="displayLog"> <!-- log activities start -->
               <div class="card-header">
                <h3 class="card-title">Login/Logout Activites</h3>
  ...
  <b-table-simple caption-top hover striped  responsive="sm">
    ...
    </div> <!-- log activities end -->


    <div class="card card-primary" v-if="displayGrade"> <!-- Grade activities start  -->
        <p>Grading</p>
    </div> <!-- Grade activities end -->

    <div class="card card-primary" v-if="displayCourse"> <!-- Course activities start  -->
        <p>Course Activities</p>
    </div> <!-- Course activities end -->
</div>
</div>
    ...
    export default {
        ...
        data(){
            ...
            return{
                ...
                logOptions: [
                    {id:1, value:"Login/Logout Activity", text:"Login/Logout Activity"},
                    {id:2, value:"Grade Change Activity", text:"Grade Change Activity"},
                    {id:3, value:"Course  Activity", text:"Course  Activity"},
                ],
                form1 : new Form({
        ...
        methods: {
             displayLogMethod(){
                ...
                if(this.logSelected == 'Course  Activity'){
                    this.displayCourse = true
                    this.displayLog = false
                    this.displayGrade = false
                }
              else if(this.logSelected == 'Grade Change Activity'){
