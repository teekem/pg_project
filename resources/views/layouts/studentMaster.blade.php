...
<body id="page-top">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./images/logo3.png" width="300" height="200" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="images/student/" class="img-circle elevation-2" alt="User Image">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
            <router-link to="/sdashboard" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
              <router-link  to="/scoursereg" class="nav-link active">
        ...
        <li class="nav-item">
            <router-link to="/sprofile" class="nav-link">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="https://run.edu.ng">Redeemer's University</a>.</strong> All rights reserved.
  </footer>
